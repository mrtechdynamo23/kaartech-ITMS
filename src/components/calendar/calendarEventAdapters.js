/**
 * KaarTech ITMS Control Tower — Global Calendar Normalization & Aggregation Layer
 * 
...
const PROGRAM_GOVERNANCE_DATA = [
  {
    programId: 'PRG-001',
    programName: 'KaarTech Enterprise S/4HANA 2025 Wave 3 Rollout',
    lead: 'Fatima Al-Otaibi',
    entities: 'KaarTech Precision Systems, KaarTech Advanced Manufacturing, KaarTech Materials Technology, KaarTech Engineering Industries',
    milestones: [
  ...
  },
  {
    ...
    entities: 'All 34 KaarTech Group Entities',
    milestones: [
      { id: 'MS-HXM-01', name: 'Global Job Architecture Alignment', date: '2026-06-12', status: 'Completed', priority: 'Medium', desc: 'Harmonization of 180+ position profiles across group entities.' },
      { id: 'MS-HXM-02', name: 'Payroll & Gratuity Integration', date: '2026-07-28', status: 'Completed', priority: 'High', desc: 'Saudi labor law and GOSI compliance validation for automated EOS gratuity calculations.' },
  ...
  },
  {
    ...
    entities: 'KaarTech Autonomous Systems, KaarTech Precision Systems, KaarTech Cyber Defense, KaarTech Intelligence Labs',
    milestones: [
      { id: 'MS-ARB-01', name: 'Supplier Security Clearance Gateway', date: '2026-07-06', status: 'Completed', priority: 'High', desc: 'Automated handshake between eVendor portal and security vetting.' },
      ...
      { id: 'MS-ARB-03', name: 'Guided Sourcing Gate Review', date: '2026-10-12', status: 'Scheduled', priority: 'High', desc: 'Go/No-Go evaluation for onboarding 450 strategic enterprise suppliers.' },
      { id: 'MS-ARB-04', name: 'Supplier Network Cutover', date: '2026-11-23', status: 'Scheduled', priority: 'High', desc: 'Mandatory supplier portal cutover for all purchase orders > 500k SAR.' },
    ],
  },
];
...
const RELEASE_PIPELINE_DATA = [
  { id: 'REL-2026-06', name: 'KaarTech Enterprise June Feature Sprint Release', date: '2026-06-30', timeWindow: '21:00 – 05:00 AST', type: 'Major Release', status: 'Deployed', priority: 'P1', changesCount: 22, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-07A', name: 'July Critical Hotfix & Tax Patch', date: '2026-07-15', timeWindow: '22:00 – 03:00 AST', type: 'Emergency Patch', status: 'Deployed', priority: 'High', changesCount: 4, owner: 'Financial Systems Lead', app: 'SAP S/4HANA Finance' },
  { id: 'REL-2026-07B', name: 'July KaarTech Enterprise Maintenance Bundle', date: '2026-07-31', timeWindow: '22:00 – 04:00 AST', type: 'Major Release', status: 'Deployed', priority: 'High', changesCount: 18, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-08A', name: 'D365 Field Service Enterprise Sprint 4', date: '2026-08-07', timeWindow: '23:00 – 02:00 AST', type: 'Cloud Release', status: 'Deployed', priority: 'Medium', changesCount: 6, owner: 'CRM Tech Lead', app: 'Microsoft Dynamics 365' },
  { id: 'REL-2026-08B', name: 'KaarTech Enterprise August Maintenance Bundle', date: '2026-08-28', timeWindow: '22:00 – 04:00 AST', type: 'Major Release', status: 'Deployed', priority: 'High', changesCount: 14, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-09A', name: 'SAC Executive Boardroom Telemetry Patch', date: '2026-09-10', timeWindow: '22:00 – 01:00 AST', type: 'BI Analytics Patch', status: 'Scheduled', priority: 'Medium', changesCount: 5, owner: 'Analytics Lead', app: 'SAP Analytics Cloud' },
  { id: 'REL-2026-09B', name: 'KaarTech Enterprise September Production Sprint', date: '2026-09-28', timeWindow: '21:00 – 04:00 AST', type: 'Major Release', status: 'Scheduled', priority: 'P1', changesCount: 26, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-10A', name: 'S/4HANA Feature Pack 02 Application Rollout', date: '2026-10-09', timeWindow: '21:00 – 05:00 AST', type: 'Feature Pack', status: 'Scheduled', priority: 'P1', changesCount: 19, owner: 'Core Architecture', app: 'SAP S/4HANA Core' },
  { id: 'REL-2026-10B', name: 'October KaarTech Enterprise Maintenance Bundle', date: '2026-10-30', timeWindow: '22:00 – 04:00 AST', type: 'Monthly Release', status: 'Scheduled', priority: 'High', changesCount: 16, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-11A', name: 'SuccessFactors Year-End Performance Patch', date: '2026-11-06', timeWindow: '22:00 – 01:00 AST', type: 'HR Cloud Patch', status: 'Scheduled', priority: 'Medium', changesCount: 7, owner: 'HR Tech Lead', app: 'SAP SuccessFactors' },
  { id: 'REL-2026-11B', name: 'November KaarTech Enterprise Production Sprint', date: '2026-11-27', timeWindow: '21:00 – 04:30 AST', type: 'Major Release', status: 'Scheduled', priority: 'P1', changesCount: 24, owner: 'CAB Release Manager', app: 'KaarTech Enterprise Landscape' },
  { id: 'REL-2026-12A', name: 'Year-End Financial Consolidation Hotfix', date: '2026-12-11', timeWindow: '22:00 – 02:00 AST', type: 'Hotfix Deployment', status: 'Scheduled', priority: 'High', changesCount: 8, owner: 'Financial Systems Lead', app: 'SAP Group Reporting' },
];
...
const OPERATIONAL_MEETINGS = [
  { id: 'MTG-001', title: 'AMS Daily Operational Handover', date: '2026-06-15', time: '14:00 – 14:30 AST', owner: 'Service Delivery Lead', status: 'Completed', priority: 'Medium', entity: 'Riyadh Ops Center', domain: 'Cross-Domain', serviceDomain: 'Service Management, Governance, and Delivery', desc: 'Daily shift sync reviewing incident ticket backlog, open P1/P2s, and critical batch runs.' },
  { id: 'MTG-002', title: 'Weekly Operational CAB Review', date: '2026-07-14', time: '11:00 – 12:30 AST', owner: 'CAB Lead', status: 'Completed', priority: 'High', entity: 'KaarTech Group HQ', domain: 'Cross-Domain', serviceDomain: 'Service Management, Governance, and Delivery', desc: 'Weekly change advisory board reviewing 18 upcoming production change requests and risk assessments.' },
  { id: 'MTG-003', title: 'Monthly Executive SteerCom Review (MSR)', date: '2026-07-02', time: '14:00 – 16:00 AST', owner: 'Dr. Tariq Al Nuaimi', status: 'Completed', priority: 'High', entity: 'KaarTech Group HQ', domain: 'Executive Governance', serviceDomain: 'Service Management, Governance, and Delivery', desc: 'Quarterly contractual executive steering committee with client leadership reviewing SLA compliance and KPI scorecard.' },
  { id: 'MTG-004', title: 'Weekly Service Review (WSR) with KaarTech Precision Systems', date: '2026-08-13', time: '10:00 – 11:30 AST', owner: 'Sultan Al Dhaheri', status: 'Completed', priority: 'Medium', entity: 'KaarTech Precision Systems', domain: 'SAP ERP and SuccessFactors', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Weekly operational review on MES shopfloor telemetry and procurement workflow resolution velocity.' },
  { id: 'MTG-005', title: 'AMS Continuous Improvement Review', date: '2026-09-03', time: '14:00 – 15:30 AST', owner: 'Quality Assurance Board', status: 'Scheduled', priority: 'Medium', entity: 'Riyadh Ops Center', domain: 'Cross-Domain', serviceDomain: 'Architecture, Quality, and Testing', desc: 'Bi-weekly retrospective on recurring problem tickets, known error articles, and automation candidates.' },
  { id: 'MTG-006', title: 'Weekly Service Review (WSR) with KaarTech Heavy Mobility', date: '2026-09-17', time: '10:00 – 11:30 AST', owner: 'Mansoor Al Ketbi', status: 'Scheduled', priority: 'Medium', entity: 'KaarTech Heavy Mobility', domain: 'SAP ERP and SuccessFactors', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Review of warranty claim dispatch workflows, serial number traceability, and S/4HANA batch performance.' },
  { id: 'MTG-007', title: 'Monthly Executive SteerCom Review (MSR)', date: '2026-10-07', time: '14:00 – 16:00 AST', owner: 'Dr. Tariq Al Nuaimi', status: 'Scheduled', priority: 'High', entity: 'KaarTech Group HQ', domain: 'Executive Governance', serviceDomain: 'Service Management, Governance, and Delivery', desc: 'SteerCom review for Q3 operational performance, SLA penalties, and Q4 change freeze dates.' },
  { id: 'MTG-008', title: 'Weekly Service Review (WSR) with KaarTech Advanced Manufacturing', date: '2026-10-22', time: '10:00 – 11:30 AST', owner: 'Hassan Al Hammadi', status: 'Scheduled', priority: 'Medium', entity: 'KaarTech Advanced Manufacturing', domain: 'SAP ERP and SuccessFactors', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'MES-to-ERP batch latency review, quality certificate automation, and export control validation.' },
  { id: 'MTG-009', title: 'Weekly Service Review (WSR) with KaarTech Autonomous Systems', date: '2026-11-05', time: '10:00 – 11:30 AST', owner: 'Omar Al Suwaidi', status: 'Scheduled', priority: 'Medium', entity: 'KaarTech Autonomous Systems', domain: 'SAP ERP and SuccessFactors', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Subcontract PO clearance, Ariba guided sourcing adoption, and BOM revision synchronization.' },
  { id: 'MTG-010', title: 'Monthly Executive SteerCom Review (MSR)', date: '2026-12-02', time: '14:00 – 16:00 AST', owner: 'Dr. Tariq Al Nuaimi', status: 'Scheduled', priority: 'High', entity: 'KaarTech Group HQ', domain: 'Executive Governance', serviceDomain: 'Service Management, Governance, and Delivery', desc: 'November SLA review, approval of annual change moratorium dates, and 2027 AMS capacity planning sign-off.' },
];
...
const TRAINING_CLINICS = [
  { id: 'TRN-001', title: 'SAP Fiori Advanced Analytics Clinic', date: '2026-06-23', time: '14:00 – 16:00 AST', owner: 'Fiori Lead', audience: 'Entity Directors & Functional Leads', status: 'Completed', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Executive training on personalizing Fiori cards, SAC storybooks, and real-time drilldowns.' },
  { id: 'TRN-002', title: 'S/4HANA Period-End Closing Runbook', date: '2026-07-21', time: '10:00 – 12:30 AST', owner: 'Lead Financial Consultant', audience: 'Finance & Controlling Teams', status: 'Completed', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Standard operating procedures for accelerated fiscal close and automated intercompany matching.' },
  { id: 'TRN-003', title: 'MES Shopfloor Operator Training', date: '2026-08-11', time: '09:00 – 12:00 AST', owner: 'MES Specialist', audience: 'Plant Technicians & Line Supervisors', status: 'Completed', serviceDomain: 'Applications, Digital, and Integration', desc: 'Hands-on clinic on digital work instructions, quality checklists, and shopfloor barcode dispatch.' },
  { id: 'TRN-004', title: 'Ariba Guided Sourcing Masterclass', date: '2026-09-15', time: '14:00 – 16:00 AST', owner: 'Procurement Specialist', audience: 'Buyers & Procurement Officers', status: 'Scheduled', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'End-to-end guidance on RFQ creation, automated tier-1 evaluation, and contract workspaces.' },
  { id: 'TRN-005', title: 'ITIL Incident Escalation Enablement', date: '2026-10-13', time: '11:00 – 13:00 AST', owner: 'ITSM Process Owner', audience: 'Tier 1 Service Desk & Track Leads', status: 'Scheduled', serviceDomain: 'IT Helpdesk & End User Services', desc: 'Best practices for priority triage, major incident mobilization, and post-incident root cause documentation.' },
  { id: 'TRN-006', title: 'SuccessFactors Goal Review Clinic', date: '2026-11-10', time: '14:00 – 15:30 AST', owner: 'HR Tech Specialist', audience: 'Group HR Managers & People Leads', status: 'Scheduled', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Annual employee review cycle workflows, calibration matrix, and merit increment calculations.' },
  { id: 'TRN-007', title: 'Ariba Contract Milestone Invoicing', date: '2026-11-23', time: '14:00 – 16:00 AST', owner: 'Ariba Lead', audience: 'Procurement Specialists & SCM Leads', status: 'Scheduled', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Training procurement specialists on milestone payment releases and compliance gates.' },
  { id: 'TRN-008', title: 'Year-End Closing Audit Preparation', date: '2026-12-08', time: '10:00 – 13:00 AST', owner: 'Lead Financial Architect', audience: 'Accounting Managers & Controllers', status: 'Scheduled', serviceDomain: 'SAP ERP and SuccessFactors', desc: 'Preparation of statutory financial schedules and external auditor workpaper packs.' },
];
 ...
 */
const SLA_REVIEWS = [
  { id: 'SLA-REV-01', title: 'June Contractual SLA Review', date: '2026-06-30', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Completed', priority: 'High', desc: 'Monthly contractual SLA performance evaluation against 99.5% target. Result: 99.4% achieved.' },
  { id: 'SLA-REV-02', title: 'July Contractual SLA Review', date: '2026-07-31', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Completed', priority: 'High', desc: 'Monthly review verifying P1/P2 response SLA (100% met) and resolution SLA (98.8% met).' },
  { id: 'SLA-REV-03', title: 'August Contractual SLA Review', date: '2026-08-31', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Completed', priority: 'High', desc: 'Monthly review verifying MTTR reduction and zero contractual penalty points accrued.' },
  { id: 'SLA-REV-04', title: 'September Contractual SLA Review', date: '2026-09-30', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Scheduled', priority: 'High', desc: 'Quarterly review including customer satisfaction scores and root cause analysis for breached tickets.' },
  { id: 'SLA-REV-05', title: 'October Contractual SLA Review', date: '2026-10-30', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Scheduled', priority: 'High', desc: 'Monthly performance scorecard sign-off and service credit ledger audit.' },
  { id: 'SLA-REV-06', title: 'November Contractual SLA Review', date: '2026-11-30', time: '16:00 – 17:30 AST', owner: 'SLA Governance Lead', status: 'Scheduled', priority: 'High', desc: 'Pre-year-end SLA review and SLA target recalibration for 2027 contract year.' },
  { id: 'SLA-REV-07', title: 'Year-End Comprehensive SLA Review', date: '2026-12-22', time: '14:00 – 16:30 AST', owner: 'Dr. Tariq Al Nuaimi', status: 'Scheduled', priority: 'Critical', desc: 'Comprehensive annual contractual review with KaarTech Group executive sponsors.' },
];
...
const CUSTOMER_CORNER_SESSIONS = [
  ...
  { id: 'CUST-SES-04', title: 'Customer Review with KaarTech Advanced Manufacturing', date: '2026-09-16', time: '11:00 – 12:30 AST', owner: 'Customer Success Lead', customer: 'KaarTech Advanced Manufacturing', status: 'Scheduled', desc: 'Reviewing recent incident trends, automated ticket dispatch, and training requirements.' },
  { id: 'CUST-SES-05', title: 'Customer Review with KaarTech Autonomous Systems', date: '2026-10-14', time: '14:00 – 15:30 AST', owner: 'Customer Success Lead', customer: 'KaarTech Autonomous Systems', status: 'Scheduled', desc: 'Engagement session reviewing supply chain ticket turnaround and vendor portal usability.' },
  { id: 'CUST-SES-06', title: 'Customer Review with International Operations', date: '2026-11-12', time: '13:00 – 14:30 AST', owner: 'Customer Success Lead', customer: 'International Operations (Nordic)', status: 'Scheduled', desc: 'International entity support review, time zone coverage feedback, and secure messaging integration.' },
  { id: 'CUST-SES-07', title: 'Customer Advisory Board Session', date: '2026-12-09', time: '14:00 – 16:00 AST', owner: 'Customer Experience Lead', customer: 'All 34 Entities', status: 'Scheduled', desc: 'Annual executive advisory meeting gathering voice-of-the-customer inputs for 2027 AMS roadmap.' },
];
...
export function normalizeCalendarEvents() {
  ...
  activeLeaves.forEach(l => {
    ...
    events.push({
      ...
      title,
      shortTitle,
      description: `${l.leaveType || 'Leave'} for ${resName} (${l.serviceDomain || l.domain || 'AMS Services'}). Backup resource: ${l.backupResourceName || l.backupResource || 'Nominated Lead'}. Handover notes: ${l.coverageNotes || 'Operational handover confirmed.'}`,
      ...
      relatedServiceDomain: l.serviceDomain || l.domain || 'AMS Operations',
  ...
  if (Array.isArray(audits)) {
    audits.forEach(a => {
      ...
      events.push({
        ...
        title,
        shortTitle,
        description: a.scope || a.description || `${a.type || 'Compliance'} audit covering ${a.serviceDomain || 'KaarTech Enterprise'} operations.`,
        startDate: startDate,
        endDate: endDate,
        startTime: a.time || a.timeWindow || '09:00 – 16:00 AST',
        endTime: '16:00 AST',
        allDay: !a.time && !a.timeWindow,
        status: a.auditStatus || a.status || 'Planned',
        priority: a.priority || 'High',
        owner: a.owner || a.leadAuditor || 'Ahmad Al-Otaibi',
        entityId: a.entity || 'KaarTech Group HQ',
        customerOrEntity: a.entity || 'KaarTech Group HQ',
        relatedServiceDomain: a.serviceDomain || a.domain || 'SAP ERP and SuccessFactors',
  ...
  if (Array.isArray(findings)) {
    findings.forEach(f => {
      ...
      events.push({
        ...
        entityId: f.entity || 'KaarTech Group',
        customerOrEntity: f.entity || 'KaarTech Group',
        relatedAudit: f.auditId,
        relatedCTA: f.ctaId,
        relatedServiceDomain: f.serviceDomain || f.domain || 'SAP ERP and SuccessFactors',
  ...
  if (Array.isArray(changeRecords)) {
    changeRecords.forEach(c => {
      ...
      events.push({
        ...
        startTime: c.timeWindow ? c.timeWindow.split('–')[0].trim() : '22:00 AST',
        endTime: c.timeWindow && c.timeWindow.includes('–') ? c.timeWindow.split('–')[1].trim() : '02:00 AST',
        allDay: false,
        status: c.status,
  ...
  RELEASE_PIPELINE_DATA.forEach(r => {
    ...
    events.push({
      ...
      startDate: r.date,
      endDate: r.date,
      startTime: r.timeWindow ? r.timeWindow.split('–')[0].trim() : '22:00 AST',
      endTime: r.timeWindow && r.timeWindow.includes('–') ? r.timeWindow.split('–')[1].trim() : '04:00 AST',
      allDay: false,
      status: r.status,
      priority: r.priority,
      owner: r.owner,
  ...
  OPERATIONAL_MEETINGS.forEach(mtg => {
    ...
    events.push({
      ...
      startDate: mtg.date,
      endDate: mtg.date,
      startTime: mtg.time ? mtg.time.split('–')[0].trim() : '10:00 AST',
      endTime: mtg.time && mtg.time.includes('–') ? mtg.time.split('–')[1].trim() : '11:30 AST',
      allDay: false,
      status: mtg.status,
      priority: mtg.priority,
      owner: mtg.owner,
      customerOrEntity: mtg.entity,
      relatedServiceDomain: mtg.domain,
      location: 'Riyadh HQ / Teams',
      sourceModule: cfg.sourceModule,
      sourceRoute: cfg.sourceRoute,
      entityType: 'Meeting',
      cssClass: cfg.cssClass,
  ...
  if (Array.isArray(momRecords)) {
    momRecords.forEach(m => {
      ...
      events.push({
        ...
        startTime: m.meetingTime ? m.meetingTime.split('–')[0].trim() : '10:00 AST',
        endTime: m.meetingTime && m.meetingTime.includes('–') ? m.meetingTime.split('–')[1].trim() : '11:30 AST',
        allDay: false,
        status: m.momStatus,
        priority: m.overdueActionCount > 0 ? 'Critical' : 'Medium',
        owner: m.owner,
        customerOrEntity: m.customerOrEntity,
        relatedServiceDomain: m.serviceDomain,
  ...
  TRANSITION_GATES.forEach(tr => {
    ...
    events.push({
      ...
      priority: 'High',
      owner: tr.owner,
      relatedServiceDomain: tr.domain,
      sourceModule: cfg.sourceModule,
      sourceRoute: cfg.sourceRoute,
  ...
  TRAINING_CLINICS.forEach(trn => {
    ...
    events.push({
      ...
      startDate: trn.date,
      endDate: trn.date,
      startTime: trn.time ? trn.time.split('–')[0].trim() : '14:00 AST',
      endTime: trn.time && trn.time.includes('–') ? trn.time.split('–')[1].trim() : '16:00 AST',
      allDay: false,
      status: trn.status,
      priority: 'Medium',
      owner: trn.owner,
      relatedServiceDomain: trn.domain,
      location: 'KaarTech Academy / Virtual',
      sourceModule: cfg.sourceModule,
      sourceRoute: cfg.sourceRoute,
  ...
  SLA_REVIEWS.forEach(sla => {
    ...
    events.push({
      ...
      startDate: sla.date,
      endDate: sla.date,
      startTime: sla.time ? sla.time.split('–')[0].trim() : '16:00 AST',
      endTime: sla.time && sla.time.includes('–') ? sla.time.split('–')[1].trim() : '17:30 AST',
      allDay: false,
      status: sla.status,
  ...
  CUSTOMER_CORNER_SESSIONS.forEach(cust => {
    ...
    events.push({
      ...
      startDate: cust.date,
      endDate: cust.date,
      startTime: cust.time ? cust.time.split('–')[0].trim() : '11:00 AST',
      endTime: cust.time && cust.time.includes('–') ? cust.time.split('–')[1].trim() : '12:30 AST',
      allDay: false,
      status: cust.status,
      priority: 'High',
      owner: cust.owner,
