...
const INITIAL_MEASUREMENTS = [
  // Current Reporting Period (September 2026) Measurements
  { id: 'MEAS-101', slaId: 'SLA-001', slaName: 'Request Acknowledgement', period: 'Sep 2026', actualValue: 0.7, target: 1, operator: '<=', unit: 'business_days', assessedBy: 'Resource Management Lead', evidence: 'Automated tracking — average 0.7 business days', notes: 'All requests acknowledged within target', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-102', slaId: 'SLA-002', slaName: 'Candidate Shortlist', period: 'Sep 2026', actualValue: 7, target: 10, operator: '<=', unit: 'business_days', assessedBy: 'Resource Management Lead', evidence: 'Average 7 business days for processed candidates', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-103', slaId: 'SLA-003', slaName: 'Long-Term Mobilization', period: 'Sep 2026', actualValue: 25, target: 30, operator: '<=', unit: 'calendar_days', assessedBy: 'Mobilization Lead', evidence: 'All onsite mobilizations deployed within 25 days', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-104', slaId: 'SLA-004', slaName: 'Short-Term Mobilization', period: 'Sep 2026', actualValue: 8, target: 10, operator: '<=', unit: 'business_days', assessedBy: 'Mobilization Lead', evidence: 'Expedited process successfully met 8-day turnaround', notes: 'Cured and restored to compliant performance', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-105', slaId: 'SLA-005', slaName: 'Performance Replacement Shortlist', period: 'Sep 2026', actualValue: 3, target: 5, operator: '<=', unit: 'business_days', assessedBy: 'Resource Management Lead', evidence: 'Common Role replacement processed in 3 business days', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', roleType: 'Common', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-106', slaId: 'SLA-006', slaName: 'Replacement Continuity', period: 'Sep 2026', actualValue: 3, target: 5, operator: '<=', unit: 'business_days', assessedBy: 'Delivery Lead', evidence: 'Knowledge transfer completed with planned overlap', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-107', slaId: 'SLA-008', slaName: 'Attendance and approved availability', period: 'Sep 2026', actualValue: 98.2, target: 95, operator: '>=', unit: 'percent', assessedBy: 'Delivery Lead', evidence: 'Monthly availability report from attendance system — 98.2% delivered', notes: 'Exceeds SLA threshold', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-108', slaId: 'SLA-016', slaName: 'Task and milestone adherence', period: 'Sep 2026', actualValue: 95.0, target: 90, operator: '>=', unit: 'percent', assessedBy: 'Project Delivery Lead', evidence: 'Sprint and task tracking register — 95.0% milestones on time', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-03', serviceDomain: 'Applications, Digital, and Integration' },
  { id: 'MEAS-109', slaId: 'SLA-009', slaName: 'First-pass quality', period: 'Sep 2026', actualValue: 94.0, target: 90, operator: '>=', unit: 'percent', assessedBy: 'Quality Assurance Lead', evidence: 'QA Acceptance log — 94% deliverables accepted without rework', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-05', serviceDomain: 'Architecture, Quality, and Testing' },
  { id: 'MEAS-110', slaId: 'SLA-017', slaName: 'Documentation compliance', period: 'Sep 2026', actualValue: 98.0, target: 95, operator: '>=', unit: 'percent', assessedBy: 'Compliance & Quality Lead', evidence: 'Document checklist audit — 98.0% completed with full work notes', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-111', slaId: 'SLA-012', slaName: 'Timesheet accuracy and timeliness', period: 'Sep 2026', actualValue: 100, target: 100, operator: '>=', unit: 'percent', assessedBy: 'Time Management Lead', evidence: 'Monthly timesheet audit log — 100% complete and accurate submissions', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-112', slaId: 'SLA-011', slaName: 'Policy and security compliance', period: 'Sep 2026', actualValue: 100, target: 100, operator: '>=', unit: 'percent', assessedBy: 'Security & Governance Lead', evidence: 'Security compliance audit — 100% policy adherence with zero critical breaches', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-02', serviceDomain: 'Infrastructure, Cloud, and Platform Services' },
  { id: 'MEAS-113', slaId: 'SLA-010', slaName: 'Stakeholder satisfaction', period: 'Sep 2026', actualValue: 4.6, target: 4.0, operator: '>=', unit: 'score', assessedBy: 'Customer Experience Lead', evidence: 'Executive CSAT survey — 4.6 / 5 rating', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-114', slaId: 'SLA-018', slaName: 'Knowledge transfer', period: 'Sep 2026', actualValue: 100, target: 100, operator: '>=', unit: 'percent', assessedBy: 'Knowledge Management Lead', evidence: 'Formal KT checklist sign-off certificate — 100% completed', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-115', slaId: 'SLA-013', slaName: 'Timesheet Pack Submission', period: 'Sep 2026', actualValue: 2, target: 3, operator: '<=', unit: 'business_days', assessedBy: 'Time Management Lead', evidence: 'Timesheet pack submitted on 2nd business day of October', notes: '', source: 'System', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-06', serviceDomain: 'SAP ERP and SuccessFactors' },
  { id: 'MEAS-116', slaId: 'SLA-014', slaName: 'Monthly Service Report', period: 'Sep 2026', actualValue: 3, target: 5, operator: '<=', unit: 'business_days', assessedBy: 'Delivery Lead', evidence: 'Monthly report delivered on 3rd business day', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
  { id: 'MEAS-117', slaId: 'SLA-015', slaName: 'Contract Deliverables Compliance', period: 'Sep 2026', actualValue: 100, target: 100, operator: '>=', unit: 'percent', assessedBy: 'Compliance Lead', evidence: 'All monthly contractual deliverables validated and archived', notes: '', source: 'Manual', timestamp: '2026-09-15T09:00:00', status: 'MET', serviceDomainId: 'TWR-07', serviceDomain: 'Service Management, Governance, and Delivery' },
