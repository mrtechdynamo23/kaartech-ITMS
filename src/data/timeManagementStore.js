...
const INITIAL_LEAVE_RECORDS = [
  {
    ...
    coverageNotes: 'Manufacturing plant floor ticket queue delegated to Hassan Al Nuaimi. Primary escalation to General Shift.',
    workflow: [
...
const INITIAL_TIMESHEET_RECORDS = [
  {
    ...
    month: 8,
    year: 2026,
    assignment: 'SAP SD AMS Operations',
    regularHours: 168,
    overtimeHours: 6,
    leaveDays: 0,
    totalDays: 22,
  ...
  },
  {
    ...
    month: 8,
    year: 2026,
    assignment: 'SuccessFactors AMS Operations',
    regularHours: 152,
    overtimeHours: 0,
    leaveDays: 1,
    totalDays: 22,
  ...
  },
  {
    ...
    month: 8,
    year: 2026,
    assignment: 'SAP PP/QM AMS Operations',
    regularHours: 136,
    overtimeHours: 4,
    leaveDays: 3,
    totalDays: 22,
