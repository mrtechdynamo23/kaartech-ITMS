/**
 * KaarTech ITMS Control Tower — Problem Improvement & Prevention
...
export default function ProblemImprovementPage() {
  const initiatives = [
    { title: 'S/4HANA Sales Order Lock Optimization', serviceDomain: 'SAP ERP and SuccessFactors', impact: 'Eliminated 45 recurring lock incidents/month', status: 'Completed', owner: 'Khalid Al-Qahtani' },
    { title: 'Ariba Supplier Punchout Timeout Fix', serviceDomain: 'SAP ERP and SuccessFactors', impact: 'Reduces cart sync failures by 80%', status: 'In Testing', owner: 'Noura Al-Dosari' },
    { title: 'SuccessFactors Batch Delta Sync Re-try Agent', serviceDomain: 'SAP ERP and SuccessFactors', impact: 'Self-heals transient network timeouts', status: 'Completed', owner: 'Sarah Al-Ghamdi' },
    { title: 'MES Production Order Status Auto-Reconciliation', serviceDomain: 'Applications, Digital, and Integration', impact: 'Prevents plant floor work order discrepancies', status: 'In Development', owner: 'Priya Nair' },
  ];
            ...
            <div key={idx} style={{ background: 'var(--bg-secondary)', padding: '16px 20px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-secondary)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                  <span className="badge badge-neutral" style={{ fontSize: '11px', fontWeight: 600 }}>{ini.serviceDomain}</span>
