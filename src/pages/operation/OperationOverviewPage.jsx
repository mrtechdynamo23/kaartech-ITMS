/**
 * KaarTech ITMS Control Tower — Service Operation Overview
    ...
    <div className="operation-overview-page animate-fade-in">
      ...
      <div className="chart-card">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '14px' }}>
          {[
            { time: '08:00 AST Daily', title: 'AMS Daily Operational Standup', participants: 'All Pod Leads & Shift Commanders', output: 'Blocker clearance & P1/P2 bridge alignment' },
            { time: '14:00 AST Daily', title: 'Daily Flash Report (DFR) Review', participants: 'AMS Lead & Service Manager', output: 'Executive 24h operational snapshot publication' },
            { time: '10:00 AST Thursdays', title: 'Weekly Service Review (WSR)', participants: 'Domain Leads & Entity SPOCs', output: 'Weekly trend analysis & problem reviews' },
            { time: 'Monthly 1st Week', title: 'Monthly Executive SteerCom (MSR)', participants: 'KaarTech Program Director & Leadership', output: 'Contractual SLA sign-off & innovation credits' },
          ].map((cad, idx) => (
            <div key={idx} style={{ background: 'var(--bg-secondary)', padding: '16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-secondary)' }}>
              <div style={{ fontSize: 'var(--text-xs)', fontWeight: 700, color: 'var(--brand-primary)', marginBottom: '4px' }}>{cad.time}</div>
